...
- Continutul trebuie extins constant prin colectare de informatii noi, relevante, din surse credibile citate.
...
- Fiecare capitol trebuie sa contina explicit: ce invata candidatul, ce trebuie sa pregateasca, ce surse verifica.
...
7. Adaugam recurent informatii noi utile pentru studiu (resurse, clarificari, exemple pe subiecte relevante).
...
- organizare clara intre zona de studiu si zona administrativa de inscriere
